...
This example builds the default LHCb point-8 model, inspects its decay channels, computes the pole position, plots the amplitude, and evaluates naive branching ratios.
...
```
    ...
    (neutral_DxD = 3.87168, charged_DxD = 3.87984, Jpsi_rho = 3.37604, Jpsi_omega = 3.51561)
...
```
    ...
    (real = 0.049519996474849816, width = 0.12074344851079337)
