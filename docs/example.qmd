...
This example builds the default LHCb point-8 model, inspects its decay channels,
computes the pole position, plots the amplitude, and evaluates naive branching ratios.
